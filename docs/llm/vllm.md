...
| `VLLM(String baseUrl, String model, Integer maxCompletionTokens)` | 指定最大 token 数 |
| `VLLM(String baseUrl, String apiKey, String model, Integer maxCompletionTokens, ChainCallback callback)` | 完整参数 |
